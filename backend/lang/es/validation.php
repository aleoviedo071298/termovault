...
|--------------------------------------------------------------------------
|
| Mensajes de validación en español para alinear las respuestas de la API
| con la interfaz (lang="es"). Evita filtrar los textos por defecto de
| Laravel en inglés (p. ej. "The email field is required.").
|
*/
