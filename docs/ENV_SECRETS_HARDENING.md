# Hardening de Archivos .env y Secrets
...
GitHub secret scanning es automático sobre repos públicos; agregá escaneo adicional en Actions si hace falta.
...
| Verificar no está committed | `git log -p -- backend/.env \| head` | Si ves cambios, el secret está en historia |
